...
class Character extends FlxSprite
{
	...
	public function dance()
	{
		if (!debugMode && !specialAnim)
		{
			...
			else if(animation.getByName('idle' + idleSuffix) != null) {					//this is the code imported from splatoon engine 0.4
				if (curCharacter.toLowerCase() == 'ezili') {											//its used for the hit notes within octo-amazone
					danced = !danced;
					if (danced)
